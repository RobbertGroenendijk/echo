...
AudioSynthWaveformSine   sine1;          //xy=545,474
AudioEffectFreeverb      freeverb1;      //xy=714,259
...
void setup() {
  installation.setup();
  installation.setupAudioProcessor(&i2s1,&i2s2,&mixer1,&mixer2,&peak1,&sine1,&freeverb1,&delay1,&sgtl5000_1);
